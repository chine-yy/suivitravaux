    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('role-dynamique.roles.create')); ?>" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('role-dynamique.roles.index')); ?>" method="GET" class="row g-3">
                    <div class="col-md-9">
                        ...
                        <table class="table table-hover mb-0" id="rolesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <a href="<?php echo e(route('role-dynamique.roles.show', $role->id)); ?>" class="btn btn-sm btn-outline-primary" title="Voir détails">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <?php endif; ?>
                                            <?php if(auth()->user()->hasPermission('edit-roles-permissions')): ?>
                                            <a href="<?php echo e(route('role-dynamique.roles.edit', $role)); ?>" class="btn btn-sm btn-outline-secondary" title="Modifier les permissions">
                                            ...
                                            <form action="<?php echo e(route('role-dynamique.roles.destroy', $role)); ?>" method="POST" onsubmit="return confirm('Supprimer ce rôle ?');" class="d-inline">
                                ...
                                <i class="bi bi-shield-x" style="font-size:2rem;"></i>
                                        <p class="mt-2">Aucun rôle créé. <a href="<?php echo e(route('role-dynamique.roles.create')); ?>">Créer le premier rôle</a></p>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
...
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/roles/index.blade.php ENDPATH**/ ?>