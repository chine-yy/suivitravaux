    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <a class="footer-brand d-flex align-items-center" href="/">
                    <img src="<?php echo e(asset('image/cnrst.png')); ?>" alt="CNRST" style="height:36px; width:auto; margin-right:10px; object-fit:contain;">
                    <span class="footer-brand-text"><?php echo e(config('app.name')); ?></span>
                </a>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="mb-0">&copy; 2026 <?php echo e(config('app.name')); ?>. Tous droits réservés.</p>
            </div>
        </div>
    </div>
</footer>

<?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/includes/footer.blade.php ENDPATH**/ ?>