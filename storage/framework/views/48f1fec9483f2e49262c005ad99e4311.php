    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('super-admin.export.users.pdf')); ?>" class="btn btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf me-2"></i>Exporter PDF
                </a>
                <a href="<?php echo e(route('super-admin.users.create')); ?>" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('super-admin.users.index')); ?>" method="GET" class="row g-3">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="<?php echo e(route('super-admin.users.index')); ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="cp-chart-card h-100">
                    ...
                    <div class="cp-chart-body p-3" style="height:340px; position:relative;">
                            ...
                            <tbody>
                                ...
                                <tr class="user-row">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="<?php echo e(route('super-admin.users.show', $user)); ?>"
                                            ...
                                            <form action="<?php echo e(route('super-admin.users.reset-password', $user)); ?>"
                                                method="POST"
                                            ...
                                            <?php if(!$user->isAdminEntreprise() && !$user->isSuperAdmin()): ?>
                                                <form action="<?php echo e(route('super-admin.users.destroy', $user)); ?>" method="POST"
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mt-2">Aucun utilisateur créé. <a
                                                href="<?php echo e(route('super-admin.users.create')); ?>">Créer le premier
                                                utilisateur</a></p>
                                    </td>
                                </tr>
                                <?php endif; ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const rawData = JSON.parse(canvas.dataset.users || '[]').filter(r => r.count > 0);
        ...
        if (rawData.length > 0) {
            new Chart(canvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(0, 154, 68, 0.85)',
                        hoverBackgroundColor: '#007a35',
                        borderRadius: 8,
                        borderSkipped: false,
                        barPercentage: 0.55,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: function (ctx) {
                                    return ` ${ctx.parsed.y} utilisateur(s)`;
                                }
                            }
                        }
                    },
            ...
            canvas.parentElement.innerHTML = `
                <div class="d-flex flex-column align-items-center justify-content-center h-100 text-muted" style="min-height:200px;">
                    ...
                    <p class="small mb-0">Aucun utilisateur assigné à un rôle</p>
                </div>`;
        }
    });
</script>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/users/index.blade.php ENDPATH**/ ?>