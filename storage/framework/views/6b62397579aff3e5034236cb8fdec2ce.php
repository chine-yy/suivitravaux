        ...
        <div class="cp-content">
            <div class="cp-page-header">
                ...
                <div class="d-flex gap-2">
                    <?php if($canPermission('exporter-pdf-projets')): ?>
                    ...
                    <?php endif; ?>
                    <?php if($canPermission('create-projets')): ?>
                        <a href="<?php echo e(route('role-dynamique.projets.create')); ?>" class="btn btn-primary px-4">
            ...
            <div class="cp-chart-card mb-4">
                ...
                <div class="p-4">
                    <form action="<?php echo e(route('role-dynamique.projets.index')); ?>" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-2">
                            ...
                            <a href="<?php echo e(route('role-dynamique.projets.index')); ?>" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex gap-1 justify-content-end">
                                            <?php if($canPermission('view-projets')): ?>
                                                <a href="<?php echo e(route('role-dynamique.projets.show', $projet->id)); ?>"
                                            ...
                                            <?php endif; ?>
                                            <?php if($canPermission('edit-projets')): ?>
                                                <a href="<?php echo e(route('role-dynamique.projets.edit', $projet->id)); ?>"
                                                    class="btn btn-sm btn-outline-primary" title="Modifier">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if($canPermission('delete-projets')): ?>
                                                <form action="<?php echo e(route('role-dynamique.projets.destroy', $projet->id)); ?>"
...
<?php if($canPermission('create-projets')): ?>
                                                <a href="<?php echo e(route('role-dynamique.projets.create')); ?>">Créer un projet</a>
                                            <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/projets/index.blade.php ENDPATH**/ ?>