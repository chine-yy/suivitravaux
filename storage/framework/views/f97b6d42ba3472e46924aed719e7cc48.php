...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Espace Partenaire'); ?> — <?php echo e(config('app.name')); ?></title>
    ...
    <div class="app-layout" id="appLayout">
        ...
        <aside class="app-sidebar" id="appSidebar">
            <div class="app-sidebar-header">
                <a href="<?php echo e(route('partenaire.dashboard')); ?>" class="app-brand">
                    <div class="app-brand-icon">
                        <i class="bi bi-building"></i>
                    </div>
                    <div class="app-brand-text">
                        <span class="app-brand-title"><?php echo e($nomEntreprise); ?></span>
            ...
            <nav class="app-sidebar-nav app-sidebar-nav-scroll">
                <div class="app-nav-section">
                    ...
                    <a href="<?php echo e(route('partenaire.dashboard')); ?>"
                        class="app-nav-item <?php echo e(request()->routeIs('partenaire.dashboard*') ? 'active' : ''); ?>">
                ...
                <div class="app-nav-section">
                    ...
                    <a href="<?php echo e(route('partenaire.equipe')); ?>"
                        class="app-nav-item <?php echo e(request()->routeIs('partenaire.equipe*') ? 'active' : ''); ?>">
                        <i class="bi bi-people"></i>
                        <span>Mon Équipe</span>
                    </a>
                    <a href="<?php echo e(route('partenaire.rapports')); ?>"
                        class="app-nav-item <?php echo e(request()->routeIs('partenaire.rapports*') ? 'active' : ''); ?>">
                        <i class="bi bi-file-earmark-text"></i>
                        <span>Rapports</span>
                    </a>
                    <a href="<?php echo e(route('partenaire.factures')); ?>"
                        class="app-nav-item <?php echo e(request()->routeIs('partenaire.factures*') ? 'active' : ''); ?>">
            ...
            <div class="app-sidebar-footer">
                <a href="<?php echo e(route('partenaire.parametres')); ?>" class="app-nav-item">
                    ...
                    <div class="app-user-menu dropdown">
                        <button class="app-user-btn" data-bs-toggle="dropdown">
                            <div class="app-user-avatar" id="headerAvatarWrapper">
                                <?php if($partenaire && $partenaire->photo_url): ?>
                                    <img src="<?php echo e($partenaire->photo_url); ?>" alt="Avatar" id="headerAvatarImg"
                                        onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                    <span class="app-user-avatar-fallback" style="display:none;">
                                        <?php echo e($partenaireInitials); ?>
                            ...
                            <div class="app-user-info d-none d-md-flex">
                                <?php if($partenaire): ?>
                                    <span class="app-user-name"><?php echo e($partenaire->prenom); ?> <?php echo e($partenaire->name); ?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="<?php echo e(route('partenaire.parametres')); ?>">
...
</html><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/layouts/partenaire.blade.php ENDPATH**/ ?>