    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('super-admin.fournisseurs.export')); ?>" class="btn btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf me-2"></i> Exporter
                </a>
                <a href="<?php echo e(route('super-admin.fournisseurs.create')); ?>" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('super-admin.fournisseurs.index')); ?>" method="GET" class="row g-3">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="categorie" class="form-select form-select-sm">
                            ...
                            <option value="<?php echo e($cat); ?>" <?php echo e(request('categorie')==$cat ? 'selected' : ''); ?>>
                                <?php echo e($cat); ?>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="statut" class="form-select form-select-sm">
                            ...
                            <option value="inactif" <?php echo e(request('statut')=='inactif' ? 'selected' : ''); ?>>Inactif
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="<?php echo e(route('super-admin.fournisseurs.index')); ?>"
        ...
        <div class="cp-chart-card">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="fournisseursTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($fournisseur->contact_nom): ?>
                                <?php echo e($fournisseur->contact_prenom); ?> <?php echo e($fournisseur->contact_nom); ?>
                            ...
                            <td>
                                <span
                                    class="badge <?php echo e($fournisseur->statut == 'actif' ? 'bg-success' : 'bg-secondary'); ?>">
                                    <?php echo e($fournisseur->statut == 'actif' ? 'Actif' : 'Inactif'); ?>

                                </span>
                            </td>
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="<?php echo e(route('super-admin.fournisseurs.show', $fournisseur->id)); ?>"
                                        class="btn btn-sm btn-outline-info" title="Voir">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('super-admin.export.pdf.direct', ['type' => 'fournisseur_list', 'id' => $fournisseur->id])); ?>"
                                        class="btn btn-sm btn-outline-secondary" title="Télécharger">
                                        <i class="bi bi-download"></i>
                                    </a>
                                    <a href="<?php echo e(route('super-admin.fournisseurs.edit', $fournisseur->id)); ?>"
                                        class="btn btn-sm btn-outline-primary" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>

                                    <form action="<?php echo e(route('super-admin.fournisseurs.destroy', $fournisseur->id)); ?>"
                ...
                <button class="btn btn-outline-danger" onclick="exportToPdf('id="fournisseursTable"', 'Liste des fournisseurs', 'fournisseurs_export')">                    <i class="bi bi-file-earmark-pdf me-2"></i> Exporter                </button>
                                <a href="<?php echo e(route('super-admin.fournisseurs.create')); ?>">Créer un fournisseur</a>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/fournisseurs/index.blade.php ENDPATH**/ ?>