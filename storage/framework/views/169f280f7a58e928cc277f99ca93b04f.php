...
<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(route('super-admin.users.index')); ?>" class="text-decoration-none">Utilisateurs</a>
        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <div class="cp-chart-card">
                    ...
                    <div class="p-4">
                        <form action="<?php echo e(route('super-admin.users.store')); ?>" method="POST" id="createUserForm">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <?php if($roles->isEmpty()): ?>
                                    <div class="alert alert-danger">
                                        ...
                                        Aucun rôle disponible. <a href="<?php echo e(route('super-admin.roles.create')); ?>">Créer un rôle d'abord.</a>
                                    </div>
                                <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex gap-2 pt-2">
                                ...
                                <a href="<?php echo e(route('super-admin.users.index')); ?>" class="btn btn-outline-secondary px-4">
                                    Annuler
                                </a>
                            </div>
                        </form>
            ...
            <div class="col-lg-5">
                <div class="cp-chart-card mb-3">
                    ...
                    <div class="p-4">
                        <?php if($roles->isEmpty()): ?>
                            <p class="text-muted text-center">Aucun rôle. <a href="<?php echo e(route('super-admin.roles.create')); ?>">Créer un rôle</a></p>
                        <?php else: ?>
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/users/create.blade.php ENDPATH**/ ?>