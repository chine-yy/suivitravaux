...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="modal fade" id="partenaireCountModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg rounded-4">
                    ...
                    <form action="<?php echo e(route('super-admin.partenaires.create')); ?>" method="GET">
        ...
        <div class="alert alert-warning border-0 shadow-sm mb-4 p-4" id="partenairePasswordAlert" style="background-color: #fffbeb; border-left: 5px solid #22c55e !important;">
...
<?php if($partenairesActifs > 0): ?>
            <div class="cp-stat-card">
                <div class="cp-stat-icon cp-bg-success"><i class="bi bi-person-check"></i></div>
                <div class="cp-stat-content">
                    <div class="cp-stat-value"><?php echo e($partenairesActifs); ?></div>
...
<?php endif; ?>
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('super-admin.partenaires.index')); ?>" method="GET" class="row g-3">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="<?php echo e(route('super-admin.partenaires.index')); ?>" class="btn btn-sm btn-outline-secondary">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="<?php echo e(route('super-admin.partenaires.show', $partenaire->id)); ?>" class="btn btn-sm btn-outline-info" title="Voir">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('super-admin.partenaires.edit', $partenaire->id)); ?>" class="btn btn-sm btn-outline-primary" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="<?php echo e(route('super-admin.partenaires.reset-password', $partenaire->id)); ?>"
                                        method="POST"
                                    ...
                                    <form action="<?php echo e(route('super-admin.partenaires.destroy', $partenaire->id)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux/resources/views/super-admin/partenaires/index.blade.php ENDPATH**/ ?>