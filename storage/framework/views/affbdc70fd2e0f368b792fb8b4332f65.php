            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="facturesTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <button type="button" class="btn btn-sm btn-outline-warning" title="Voir la facture" data-bs-toggle="modal" data-bs-target="#factureModal<?php echo e($facture->id); ?>">
                                        <i class="bi bi-eye"></i>
                                    </button>
                        ...
                        <div class="modal fade" id="factureModal<?php echo e($facture->id); ?>" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content border-0 rounded-4">
                                    <div class="modal-header border-bottom-0 py-4 px-4">
                                        <h5 class="modal-title fw-bold">Facture <?php echo e($facture->numero_facture); ?></h5>
                                    ...
                                    <div class="modal-body p-4">
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <p class="fw-bold text-dark fs-5"><?php echo e($facture->numero_facture); ?></p>
                                            </div>
                                            <div class="col-md-6 text-md-end">
                                                <h6 class="text-muted small text-uppercase mb-2">Projet</h6>
                                                <p class="fw-bold text-dark fs-5"><?php echo e($facture->projet->nom ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-4">
                                                <h6 class="text-muted small text-uppercase mb-2">Montant HT</h6>
                                                <p class="fw-bold"><?php echo e(number_format($facture->montant_ht, 0, ',', ' ')); ?> FCFA</p>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="text-muted small text-uppercase mb-2">TVA</h6>
                                                <p class="fw-bold"><?php echo e(number_format($facture->montant_tva, 0, ',', ' ')); ?> FCFA</p>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="text-muted small text-uppercase mb-2">Montant TTC</h6>
                                                <p class="fw-bold text-success"><?php echo e(number_format($facture->montant_ttc, 0, ',', ' ')); ?> FCFA</p>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <h6 class="text-muted small text-uppercase mb-2">Date d'émission</h6>
                                                <p class="fw-bold"><?php echo e($facture->date_emission ? date('d/m/Y', strtotime($facture->date_emission)) : 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <h6 class="text-muted small text-uppercase mb-2">Date d'échéance</h6>
                                                <p class="fw-bold"><?php echo e($facture->date_echeance ? date('d/m/Y', strtotime($facture->date_echeance)) : 'N/A'); ?></p>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <h6 class="text-muted small text-uppercase mb-2">Statut de paiement</h6>
                                                <span class="badge <?php echo e($paiementClass[$facture->statut_paiement] ?? 'bg-secondary'); ?> fs-6"><?php echo e($paiementText[$facture->statut_paiement] ?? $facture->statut_paiement); ?></span>
                                            </div>
                                            <?php if($facture->mode_paiement): ?>
                                            <div class="col-md-6">
                                                <h6 class="text-muted small text-uppercase mb-2">Mode de paiement</h6>
                                                <p class="fw-bold"><?php echo e($facture->mode_paiement); ?></p>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="bg-light rounded-4 p-4">
                                            ...
                                            <p class="text-muted mb-0"><?php echo e($facture->notes); ?></p>
                                        </div>
                                        <?php endif; ?>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.partenaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/partenaire/facture/factures.blade.php ENDPATH**/ ?>