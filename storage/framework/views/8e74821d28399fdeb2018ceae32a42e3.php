...
<head>
    ...
    <title>Bienvenue - <?php echo e(config('app.name')); ?></title>
    <style>
    ...
    <div class="container">
        <div class="email-wrapper">
            ...
            <div class="email-body">
                ...
                <p>Nous sommes ravis de vous accueillir sur <?php echo e(config('app.name')); ?>, votre solution de gestion de chantier BTP.</p>

                <div class="welcome-box">
                    <h2>📋 Récapitulatif de votre inscription</h2>
                    <div class="info-item">
                        <span class="info-label">🏢 Entreprise :</span>
                        <span class="info-value"><?php echo e($companyName); ?></span>
                    </div>
                    <div class="info-item">
                ...
                <div class="text-center">
                    <a href="<?php echo e(url('/login')); ?>" class="btn-connect">Se connecter à <?php echo e(config('app.name')); ?></a>
                </div>
...
<?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/emails/welcome.blade.php ENDPATH**/ ?>