<?php $__env->startSection('title', 'Modifier la Sous-Tâche'); ?>
    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="card-body p-4">
                <form action="<?php echo e(route('super-admin.sous-taches.update', $sousTache->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('titre', $sousTache->titre)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $taches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($t->id); ?>" data-projet-id="<?php echo e($t->projet_id); ?>" data-phase-id="<?php echo e($t->phase_id); ?>" <?php echo e(old('tache_id', $sousTache->tache_id) == $t->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="en_attente" <?php echo e($sousTache->statut == 'en_attente' ? 'selected' : ''); ?>>En attente</option>
                                <option value="en_cours" <?php echo e($sousTache->statut == 'en_cours' ? 'selected' : ''); ?>>En cours</option>
                                <option value="terminee" <?php echo e($sousTache->statut == 'terminee' ? 'selected' : ''); ?>>Terminée</option>
                                <option value="bloquee" <?php echo e($sousTache->statut == 'bloquee' ? 'selected' : ''); ?>>Bloquée</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="avancement" min="0" max="100" class="form-control <?php $__errorArgs = ['avancement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('avancement', $sousTache->avancement)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date_debut', $sousTache->date_debut?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date_fin_prevue', $sousTache->date_fin_prevue?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control" rows="3"><?php echo e($sousTache->description); ?></textarea>
                        </div>
...
unset($__errorArgs, $__bag); ?>" id="user_id_select">
                                ...
                                <?php $__currentLoopData = $membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($membre->id); ?>" <?php echo e(old('user_id', $sousTache->user_id) == $membre->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/sous-taches/edit.blade.php ENDPATH**/ ?>