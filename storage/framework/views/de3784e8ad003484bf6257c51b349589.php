...
<a href="<?php echo e(route('role-dynamique.roles.index')); ?>" class="text-decoration-none">Rôles</a>
    ...
    <div class="cp-content">
        <div class="cp-page-header">
            <div>
                ...
                <p class="cp-page-subtitle">Modifiez le role <strong><?php echo e($role->nom); ?></strong> et ses permissions</p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('role-dynamique.configuration.logs')); ?>" class="btn btn-outline-info">
                    <i class="bi bi-file-earmark-text me-2"></i>Voir les logs
                </a>
                <a href="<?php echo e(route('role-dynamique.roles.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="cp-chart-card">
                    ...
                    <div class="p-4">
                        <form action="<?php echo e(route('role-dynamique.roles.update', $role)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('nom', $role->nom)); ?>" 
                                    <?php echo e($isAdminEntreprise ? 'readonly' : ''); ?> 
                                    <?php echo e($isAdminEntreprise ? 'style="background-color: #e9ecef;"' : ''); ?>

                                    required>
                                <?php if($isAdminEntreprise): ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('role-dynamique.roles.index')); ?>" class="btn btn-outline-secondary px-4">
                                    Annuler
                                </a>
                            </div>
                        </form>
            ...
            <div class="col-lg-4">
                <div class="cp-chart-card mb-3">
                    ...
                    <div class="p-4">
                        <?php $usersRole = $role->users()->get(); ?>
                        <?php if($usersRole->count() > 0): ?>
                        <ul class="list-unstyled mb-0">
                            <?php $__currentLoopData = $usersRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="d-flex align-items-center gap-2 py-2 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                ...
                                <div>
                                    <div class="fw-semibold small"><?php echo e($u->name); ?> <?php echo e($u->prenom ?? ''); ?></div>
...
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/roles/edit.blade.php ENDPATH**/ ?>