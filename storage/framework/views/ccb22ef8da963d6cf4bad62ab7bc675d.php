        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="cp-chart-card p-4 text-center"
                    style="background:linear-gradient(135deg,#f0fdf4,#dcfce7); border: 2px dashed #10b981;">
                    <i class="bi bi-shield-plus" style="font-size:3rem;color:#10b981;"></i>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (usersCanvas) {
            ...
            if (rawData.length) {
                const palette = ['#2563eb', '#16a34a', '#84cc16', '#dc2626', '#9333ea', '#0891b2', '#22c55e', '#14b8a6', '#8b5cf6', '#84cc16'];
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux/resources/views/super-admin/dashboard.blade.php ENDPATH**/ ?>