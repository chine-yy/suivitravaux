...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/super-admin/dashboard.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/premium.css')); ?>">
...
<body data-layout="super-admin">
    ...
    <div class="app-layout" id="appLayout">
        ...
        <aside class="app-sidebar app-sidebar-super" id="appSidebar">
            <div class="app-sidebar-header">
                <a href="<?php echo e(route('super-admin.dashboard')); ?>" class="app-brand">
                    <div class="app-brand-icon app-brand-icon-super">
                        <i class="bi bi-shield-lock"></i>
                    </div>
                    <div class="app-brand-text">
                        <span class="app-brand-title"><?php echo e(config('app.name')); ?></span>
            ...
            <nav class="app-sidebar-nav app-sidebar-nav-scroll">
                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionKey => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="app-nav-section">
                        <div class="app-nav-section-title"><?php echo e($section['title']); ?></div>
                        <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <a href="<?php echo e(str_contains($item['route'], '#') ? route(explode('#', $item['route'])[0]) . '#' . explode('#', $item['route'])[1] : route($item['route'])); ?>"
                                class="app-nav-item <?php echo e($isActive ? 'active' : ''); ?>">
            ...
            <div class="app-sidebar-footer">
                <a href="<?php echo e(route('super-admin.parametres')); ?>"
                    class="app-nav-item <?php echo e(request()->routeIs('super-admin.parametres') ? 'active' : ''); ?>">
            ...
            <header class="app-header">
                <div class="app-header-left">
                    ...
                    <button type="button" class="app-back-btn"
                        onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='<?php echo e(route('super-admin.dashboard')); ?>'; }"
                        aria-label="Retour">
                        ...
                        <button class="app-user-btn" data-bs-toggle="dropdown">
                            <div class="app-user-avatar">
                                 <?php if($currentUserPhotoUrl): ?>
                                     <img src="<?php echo e($currentUserPhotoUrl); ?>" alt="Photo de profil"
                                         onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                    <span class="app-user-avatar-fallback" style="display:none;">
                                        <?php echo e($currentUserInitials); ?>
                             ...
                             <div class="app-user-info d-none d-md-flex">
                                 <span class="app-user-name"><?php echo e($currentUserName); ?></span>
                                 <span class="app-user-role">Super Administrateur</span>
                             </div>
                            <i class="bi bi-chevron-down app-user-chevron"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="<?php echo e(route('super-admin.parametres')); ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <?php if(session('success')): ?>
                pushNotification('Succès', '<?php echo e(session('success')); ?>', 'success');
            <?php endif; ?>
            <?php if(session('error')): ?>
                pushNotification('Erreur', '<?php echo e(session('error')); ?>', 'danger');
            <?php endif; ?>
            <?php if(session('warning')): ?>
                pushNotification('Attention', '<?php echo e(session('warning')); ?>', 'warning');
            <?php endif; ?>
    ...
    <?php echo $__env->make('partials.export-excel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('partials.export-pdf', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldPushContent('scripts'); ?>
    <?php echo $__env->yieldPushContent('modals'); ?>

</html>
<?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/layouts/super-admin.blade.php ENDPATH**/ ?>