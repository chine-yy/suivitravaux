        ...
        <div class="row">
                    ...
                    <div class="cp-card-body">
                        <div class="table-responsive">
                            <table class="table table-borderless table-config">
                                <tbody>
                                    <?php if($canPermission('view-base-de-donnees')): ?>
                                    <tr>
            ...
            <div class="col-lg-6 mb-4">
                <div class="cp-card mb-4">
                    ...
                    <div class="cp-card-body">
                        <div class="d-grid gap-2">
                                <a href="<?php echo e(route('role-dynamique.database.index')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="cp-card">
                    ...
                    <div class="cp-card-body">
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('role-dynamique.configuration.logs')); ?>" class="btn btn-outline-green">
...
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/configuration/index.blade.php ENDPATH**/ ?>