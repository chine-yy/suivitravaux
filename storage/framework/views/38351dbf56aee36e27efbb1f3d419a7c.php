    ...
    <div class="app-layout" id="appLayout">
        ...
        <aside class="app-sidebar" id="appSidebar">
            <div class="app-sidebar-header">
                <a href="<?php echo e(route('role-dynamique.dashboard')); ?>" class="app-brand">
                    <div class="app-brand-icon">
                        <i class="bi bi-building"></i>
                    </div>
                    <div class="app-brand-text">
                        <span class="app-brand-title"><?php echo e(config('app.name')); ?></span>
                        <span class="app-brand-subtitle"><?php echo e($roleName); ?></span>
                    </div>
                </a>
                        ...
                        <div class="app-nav-section">
                            ...
                            <?php $__currentLoopData = $section['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e($url); ?>"
                                    class="app-nav-item <?php echo e($isActive ? 'active' : ''); ?> <?php echo e($url === '#' ? 'disabled' : ''); ?>">
            ...
            <div class="app-sidebar-footer">
                <a href="<?php echo e(route('role-dynamique.parametres')); ?>" class="app-nav-item">
            ...
            <header class="app-header">
                <div class="app-header-left">
                    ...
                    <button type="button" class="app-back-btn"
                        onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='<?php echo e(route('role-dynamique.dashboard')); ?>'; }"
                        aria-label="Retour">
                        <i class="bi bi-arrow-left"></i>
                        <span class="d-none d-md-inline">Retour</span>
                    </button>
                    <nav class="app-breadcrumb d-none d-md-flex" aria-label="Fil d'Ariane">
                        <span class="app-breadcrumb-item"><?php echo e($roleName); ?></span>
                    ...
                    <div class="app-user-menu dropdown">
                        <button class="app-user-btn" data-bs-toggle="dropdown">
                            ...
                            <div class="app-user-info d-none d-md-flex">
                                <span class="app-user-name"><?php echo e($userName); ?></span>
                                <span class="app-user-role"><?php echo e($roleName); ?></span>
                            </div>
                            <i class="bi bi-chevron-down app-user-chevron"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="<?php echo e(route('role-dynamique.parametres')); ?>">
...
</html><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/layouts/role-dynamique.blade.php ENDPATH**/ ?>