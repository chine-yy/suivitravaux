...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('role-dynamique.satisfaction.index')); ?>" method="GET" class="row g-3">
                    <div class="col-md-5">
                        ...
                        <select name="partenaire_id" class="form-select form-select-sm">
                            ...
                            <option value="<?php echo e($c->id); ?>" <?php echo e(request('partenaire_id')==$c->id ? 'selected' : ''); ?>>
                                <?php echo e(trim(($c->prenom ?? '') . ' ' . ($c->name ?? '')) ?: ('Partenaire #' . $c->id)); ?>
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="<?php echo e(route('role-dynamique.satisfaction.index')); ?>"
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="satisfactionTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($satisfaction->partenaire ? trim(($satisfaction->partenaire->prenom ?? '') . ' ' . ($satisfaction->partenaire->name ?? '')) : 'N/A'); ?></td>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    ...
                                    <a href="<?php echo e(route('role-dynamique.satisfaction.show', $satisfaction->id)); ?>"
...
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/satisfaction/index.blade.php ENDPATH**/ ?>