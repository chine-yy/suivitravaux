            ...
            <div class="row g-4">
                <div class="col-lg-7 col-xl-8 order-2 order-lg-1">
                    <div class="cp-chart-card">
                        ...
                        <div class="p-4">
                            <form method="POST" action="<?php echo e(route('role-dynamique.parametres.update')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="d-flex gap-2 pt-4 border-top">
                                    ...
                                    <a href="<?php echo e(route('role-dynamique.dashboard')); ?>"
                ...
                <div class="col-lg-5 col-xl-4 order-1 order-lg-2">
                    <div class="cp-chart-card mb-4">
                        ...
                        <div class="p-4 text-center">
                            ...
                            <p class="text-muted small mb-2"><?php echo e($user->role->nom ?? 'Collaborateur'); ?></p>
                            ...
                            <div class="mt-2">
                                <form method="POST" action="<?php echo e(route('role-dynamique.parametres.photo.destroy')); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/profil/index.blade.php ENDPATH**/ ?>