<?php $__env->startSection('title', 'Nouveau Contrat'); ?>
...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="p-4">
                <form action="<?php echo e(route('super-admin.contrats.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('numero_contrat')); ?>" placeholder="Laisser vide pour une génération automatique (ex: 0001)">
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="marche" <?php echo e(old('type') == 'marche' ? 'selected' : ''); ?>>Marché</option>
                                <option value="sous_traitance" <?php echo e(old('type') == 'sous_traitance' ? 'selected' : ''); ?>>Sous-traitance</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="montant" id="montant" class="form-control <?php $__errorArgs = ['montant'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('montant')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="statut" class="form-select">
                                ...
                                <option value="signe" <?php echo e(old('statut') == 'signe' ? 'selected' : ''); ?>>Signé</option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date_fin')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objet" class="form-control" rows="3"><?php echo e(old('objet')); ?></textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Conditions</label>
                            <textarea name="conditions" class="form-control" rows="3"><?php echo e(old('conditions')); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/contrats/create.blade.php ENDPATH**/ ?>