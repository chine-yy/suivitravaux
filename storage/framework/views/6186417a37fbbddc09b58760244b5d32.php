    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header">
            <div>
                ...
                <p class="cp-page-subtitle">Consultez les rapports d'avancement envoyés par votre Chef de Projet.</p>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $rapports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rapport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="py-4">
                                                <span class="badge px-3 py-2" style="background-color: #22c55e20; color: #22c55e; border: 1px solid #22c55e40; border-radius: 6px;">
                                            ...
                                            <td class="py-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold small"><?php echo e($rapport->chefProjet ? $rapport->chefProjet->prenom . ' ' . $rapport->chefProjet->nom : 'Non spécifié'); ?></div>
                                                        <div class="text-muted extra-small" style="font-size: 0.7rem;">Chef de Projet</div>
                                                    </div>
                                                </div>
                                            </td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="p-3 bg-white border rounded-3">
                                                                    ...
                                                                    <div class="fw-bold"><?php echo e($rapport->chefProjet ? $rapport->chefProjet->prenom . ' ' . $rapport->chefProjet->nom : 'Non spécifié'); ?></div>
                                                                    <div class="text-muted small">Chef de projet <?php echo e($rapport->projet->nom); ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.partenaire', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux/resources/views/partenaire/rapport/rapports.blade.php ENDPATH**/ ?>