...
<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(route('super-admin.fournisseurs.index')); ?>" class="text-decoration-none">Fournisseurs</a>
...
<div class="cp-dashboard">
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <a href="<?php echo e(route('super-admin.fournisseurs.index')); ?>" class="btn btn-outline-secondary">
                <i class="bi bi-list"></i> Liste des Fournisseurs
            </a>
        </div>


        <form action="<?php echo e(route('super-admin.fournisseurs.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="categorie" class="form-control" value="<?php echo e(old('categorie')); ?>" placeholder="Ex: Matériaux, Équipements...">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Adresse</label>
                            <textarea name="adresse" class="form-control" rows="2"><?php echo e(old('adresse')); ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Site Web</label>
                            <input type="url" name="site_web" class="form-control" value="<?php echo e(old('site_web')); ?>">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="d-flex gap-2 pt-4">
                ...
                <a href="<?php echo e(route('super-admin.fournisseurs.index')); ?>" class="btn btn-outline-secondary px-5 py-2 fw-medium">Annuler</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/super-admin/fournisseurs/create.blade.php ENDPATH**/ ?>