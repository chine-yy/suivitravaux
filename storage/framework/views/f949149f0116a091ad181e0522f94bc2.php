...
<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(route('role-dynamique.configuration.index')); ?>" class="text-decoration-none">Configuration</a>
    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                ...
                <a href="<?php echo e(route('role-dynamique.database.backup')); ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <?php if($canExportDatabase): ?>
                                    <a href="<?php echo e(route('role-dynamique.database.export-table', ['table' => $table['name']])); ?>" class="btn btn-sm btn-outline-success">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content" style="border-radius: 16px;">
                                                ...
                                                <div class="modal-footer border-0 pt-0 justify-content-center gap-3">
                                                    ...
                                                    <form action="<?php echo e(route('role-dynamique.database.clear-table')); ?>" method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <?php if($canExportDatabase): ?>
                                                    <a href="<?php echo e(route('role-dynamique.database.export-table', ['table' => $table['name']])); ?>" class="btn btn-success">
...
<div id="clearAllContainer" class="clearAll-container" style="display: none;">
    <div class="clearAll-box" style="max-width: 520px; width: calc(100% - 32px); background: #fff; border-radius: 20px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
        ...
        <div class="d-flex justify-content-center align-items-center gap-3 px-4 pb-4 pt-2" style="border: none;">
            ...
            <form action="<?php echo e(route('role-dynamique.database.clear-all')); ?>" method="POST" style="margin: 0;">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.role-dynamique', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dydy/Documents/base/laravel/suivitravaux CNRST/resources/views/role-dynamique/database/index.blade.php ENDPATH**/ ?>