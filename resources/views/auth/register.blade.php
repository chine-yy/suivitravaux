    ...
    <div class="register-wrapper container">
        <div class="register-card">
            <div class="register-header">
                ...
                <p>Rejoignez {{ config('app.name') }} et gérez vos projets de construction</p>
            </div>
            ...
            <div class="register-body">
                ...
                <form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate id="registerForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="Ex: BTP Construction SARL" value="{{ old('company_name') }}" required>
                                @error('company_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="industry" class="form-select @error('industry') is-invalid @enderror">
                                ...
                                <option value="genie_civil" {{ old('industry') === 'genie_civil' ? 'selected' : '' }}>Génie civil</option>
                                <option value="architecture" {{ old('industry') === 'architecture' ? 'selected' : '' }}>Architecture</option>
                                <option value="autre" {{ old('industry') === 'autre' ? 'selected' : '' }}>Autre</option>
                            </select>
                            <input type="text" name="custom_industry" id="custom_industry" class="form-control mt-2 @error('custom_industry') is-invalid @enderror" placeholder="Précisez votre secteur d'activité" value="{{ old('custom_industry') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Numéro IFU</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-card-text"></i></span>
                                <input type="text" name="siret" class="form-control @error('siret') is-invalid @enderror" placeholder="Ex: 123 456 789 00012" value="{{ old('siret') }}">
                                @error('siret')
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="company_phone" class="form-control @error('company_phone') is-invalid @enderror" placeholder="+33 1 23 45 67 89" value="{{ old('company_phone') }}">
                                @error('company_phone')
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="ville" class="form-control" placeholder="Ex: Paris" value="{{ old('ville') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="pays" class="form-control" placeholder="Ex: France" value="{{ old('pays') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="site_web" class="form-control" placeholder="https://www.monentreprise.com" value="{{ old('site_web') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="company_address" class="form-control" placeholder="Rue, ville, code postal" value="{{ old('company_address') }}">
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Description (facultatif)</label>
                            <textarea name="description" class="form-control" rows="2" placeholder="Décrivez votre entreprise...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-control @error('first_name') is-invalid @enderror" placeholder="Votre prénom" value="{{ old('first_name') }}" required>
                                @error('first_name')
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-person"></i></span>
                                <input type="text" id="last_name" name="last_name" class="form-control @error('last_name') is-invalid @enderror" placeholder="Votre nom" value="{{ old('last_name') }}" required>
                                @error('last_name')
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="admin@entreprise.com" value="{{ old('email') }}" required autocomplete="email">
                                @error('email')
                                    <div class="invalid-feedback"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="phone" class="form-control" placeholder="+33 6 12 34 56 78" value="{{ old('phone') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="Min. 8 caractères" required autocomplete="new-password">
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input @error('accept_terms') is-invalid @enderror" type="checkbox" value="1" id="terms" name="accept_terms" required>
