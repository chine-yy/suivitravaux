...
@section('title', config('app.name') . ' - Solution de gestion de chantier BTP')
            ...
            <div class="row align-items-center min-vh-75">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex gap-3 mb-4 flex-wrap">
                        <a href="{{ route('entreprise.register') }}" class="btn btn-cnrst-green btn-lg rounded-pill px-4 shadow-green">
            ...
            <div class="row text-center">
                <div class="col-6 col-md-3 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-number">{{ $projetCount }}+</div>
                        <p>Projets</p>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-number">{{ $phaseCount }}+</div>
                        <p>Phases</p>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-number">{{ $tacheCount }}+</div>
                        <p>Tâches</p>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-number">{{ $userCount }}+</div>
                        <p>Utilisateurs</p>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="metric-card">
                        ...
                        <div class="metric-number">{{ $incidentCount }}+</div>
                        <p>Incidents</p>
                    </div>
                </div>
            </div>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-box">
                ...
                <a href="{{ route('entreprise.register') }}" class="btn btn-cnrst-green btn-lg rounded-pill px-5">
            ...
            <div class="row g-4">
                <div class="col-md-7">
                    <div class="contact-form-card">
                        @if(session('status'))
                            <div class="alert alert-green"><i class="bi bi-check-circle-fill me-2"></i>{{ session('status') }}</div>
                        ...
                        <form action="{{ route('contact.send') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Votre nom et prenom au complet" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="input-group">
