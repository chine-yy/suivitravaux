...
@section('title', 'Configuration Système - Super Admin')
            ...
            <div class="col-lg-6 mb-4">
                    ...
                    <div class="cp-card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if($canAnyPermission([
                                ...
                                <a href="{{ route('super-admin.database.index') }}" class="btn btn-outline-secondary">
                ...
                <div class="cp-card mb-4">
                    ...
                    <div class="cp-card-body">
                        ...
                        <div class="d-grid gap-2">
                            <a href="{{ route('super-admin.database.index') }}" class="btn btn-outline-green">
                ...
                <div class="cp-card">
                    ...
                    <div class="cp-card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('super-admin.configuration.logs') }}" class="btn btn-outline-green">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('super-admin.configuration.maintenance.toggle') }}" method="POST">
                    @csrf
