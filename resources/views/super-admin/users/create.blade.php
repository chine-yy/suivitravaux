        ...
        <div class="row g-4">
            <div class="col-lg-7">
                <div class="cp-chart-card">
                    ...
                    <div class="p-4">
                        <form action="{{ route('super-admin.users.store') }}" method="POST" id="createUserForm">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                @if($roles->isEmpty())
                                    <div class="alert alert-danger">
                                        ...
                                        Aucun rôle disponible. <a href="{{ route('super-admin.roles.create') }}">Créer un rôle d'abord.</a>
                                    </div>
                                @else
            ...
            <div class="col-lg-5">
                <div class="cp-chart-card mb-3">
                    ...
                    <div class="p-4">
                        @if($roles->isEmpty())
                            <p class="text-muted text-center">Aucun rôle. <a href="{{ route('super-admin.roles.create') }}">Créer un rôle</a></p>
                        @else
                        @foreach($roles as $role)
