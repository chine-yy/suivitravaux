    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('super-admin.export.users.pdf') }}" class="btn btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf me-2"></i>Exporter PDF
                </a>
                <a href="{{ route('super-admin.users.create') }}" class="btn btn-primary px-4">
            ...
            <div class="p-4">
                <form action="{{ route('super-admin.users.index') }}" method="GET" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('super-admin.users.index') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mt-2">Aucun utilisateur créé. <a
                                                href="{{ route('super-admin.users.create') }}">Créer le premier
                                                utilisateur</a></p>
                                    </td>
                                </tr>
                                @endforelse
