    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('super-admin.rendezvous.edit', $rendezvous->id) }}" class="btn btn-primary px-4">
                    <i class="bi bi-pencil me-2"></i>Modifier
                </a>
                <a href="{{ route('super-admin.rendezvous.index') }}" class="btn btn-outline-secondary px-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="p-4">
                        @if($rendezvous->projet)
                            ...
                            <div class="d-grid mt-3">
                                <a href="{{ route('super-admin.projets.show', $rendezvous->projet->id) }}" class="btn btn-sm btn-outline-success">
                ...
                <div class="mt-4 p-2">
                    <form action="{{ route('super-admin.rendezvous.destroy', $rendezvous->id) }}" method="POST" class="d-inline">
                        @csrf @method('DELETE')
