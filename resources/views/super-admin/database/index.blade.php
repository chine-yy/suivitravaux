...
@section('breadcrumb')
    <a href="{{ route('super-admin.configuration.index') }}" class="text-decoration-none">Configuration</a>
    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                ...
                <a href="{{ route('super-admin.database.backup') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    @if($canExportDatabase)
                                    <a href="{{ route('super-admin.database.export-table', ['table' => $table['name']]) }}" class="btn btn-sm btn-outline-success">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content" style="border-radius: 16px;">
                                                ...
                                                <div class="modal-footer border-0 pt-0 justify-content-center gap-3">
                                                    ...
                                                    <form action="{{ route('super-admin.database.clear-table') }}" method="POST" class="d-inline">
                                                        @csrf
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    @if($canExportDatabase)
                                                    <a href="{{ route('super-admin.database.export-table', ['table' => $table['name']]) }}" class="btn btn-success">
...
<div id="clearAllContainer" class="clearAll-container" style="display: none;">
    <div class="clearAll-box" style="max-width: 520px; width: calc(100% - 32px); background: #fff; border-radius: 20px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
        ...
        <div class="d-flex justify-content-center align-items-center gap-3 px-4 pb-4 pt-2" style="border: none;">
            ...
            <form action="{{ route('super-admin.database.clear-all') }}" method="POST" style="margin: 0;">
                @csrf
