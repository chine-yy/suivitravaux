...
<div class="d-flex gap-2">
                ...
                <a href="{{ route('super-admin.incidents.create') }}" class="btn btn-green btn-with-border">
        ...
        <div class="cp-card mb-4 shadow-sm border-0">
            ...
            <div class="p-4">
                <form action="{{ route('super-admin.incidents.index') }}" method="GET" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('super-admin.incidents.index') }}" class="btn btn-sm btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('super-admin.incidents.show', $incident->id) }}" class="btn btn-sm btn-outline-info" title="Voir détails">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        @include('partials.row-export', ['id' => $incident->id, 'prefix' => 'incident', 'title' => 'Incident - ' . ($incident->titre ?? $incident->id)])
                                        <a href="{{ route('super-admin.incidents.edit', $incident->id) }}" class="btn btn-sm btn-outline-green" title="Modifier">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('super-admin.incidents.destroy', $incident->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet incident ?');" class="d-inline">
                                            @csrf
                                            @method('DELETE')
