        ...
        <div class="cp-content">
            <div class="cp-page-header">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('super-admin.sous-traitances.edit', $sousTraitance->id) }}"
                        class="btn btn-green px-4 text-white">
                        <i class="bi bi-pencil me-2"></i>Modifier
                    </a>
                    <a href="{{ route('super-admin.sous-traitances.index') }}" class="btn btn-outline-secondary px-4">
                    ...
                    <div class="cp-chart-card shadow-sm border-0 sticky-top" style="top: 2rem;">
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 pt-4 border-top">
                                <div class="d-grid">
                                    <form action="{{ route('super-admin.sous-traitances.destroy', $sousTraitance->id) }}"
                                        method="POST" class="d-inline">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="btn btn-outline-danger w-100"
                                            onclick="return confirm('Attention ! Supprimer cette sous-traitance ?')">
                                            <i class="bi bi-trash me-2"></i>Supprimer ce contrat
                                        </button>
                                    </form>
                                </div>
                            </div>
