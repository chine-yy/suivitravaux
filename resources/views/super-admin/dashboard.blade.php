    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header">
            <div>
                ...
                <p class="cp-page-subtitle">Vue d'ensemble globale — {{ now()->format('d/m/Y') }}</p>
            </div>
        </div>
        ...
        <div class="cp-stats-grid" id="cp-stats-grid" data-section-name="statistiques">
            <div class="cp-stat-card">
                ...
                <div class="cp-stat-content">
                    <div class="cp-stat-value">{{ $totalProjets }}</div>
            ...
            <div class="cp-stat-card">
                ...
                <div class="cp-stat-content">
                    <div class="cp-stat-value">{{ $projetsTermines }}</div>
            ...
            <div class="cp-stat-card cp-stat-danger">
                ...
                <div class="cp-stat-content">
                    <div class="cp-stat-value">{{ $projetsEnRetard }}</div>
            ...
            <div class="cp-stat-card">
                ...
                <div class="cp-stat-content">
                    <div class="cp-stat-value">{{ $totalRapports }}</div>
        ...
        <div class="cp-stats-grid mt-3" data-section-name="utilisateurs roles">
            <div class="cp-stat-card" style="cursor:pointer;"
                onclick="window.location='{{ route('super-admin.users.index') }}'">
            ...
            <div class="cp-stat-card" style="cursor:pointer;"
                onclick="window.location='{{ route('super-admin.roles.index') }}'">
        ...
        <div class="row mt-4" id="section-budget" data-section-name="budget">
            <div class="col-md-12">
                <div class="cp-stat-card cp-stat-card-budget w-100">
                    ...
                    <div class="cp-stat-content">
                        <div class="cp-stat-value">{{ number_format($budgetGlobal, 0, ',', ' ') }} FCFA</div>
        ...
        <div class="cp-charts-grid mt-4" id="section-graphiques" data-section-name="graphiques">
            <div class="cp-chart-card">
                ...
                <div class="cp-chart-body">
                    <div class="cp-project-progress-list">
                        @forelse($avancementProjets as $projet)
                        <div class="cp-project-progress">
                            ...
                            <div class="cp-progress-bar-container">
                                <div class="cp-progress-bar bg-green" style="width: {{ $projet['avancement'] }}%">
                                </div>
                            </div>
                        </div>
                        @empty
            ...
            <div class="cp-chart-card">
                ...
                <div class="cp-chart-body">
                    <canvas id="cp-repartition-chart" data-statuts='@json($repartitionStatuts)'></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4" data-section-name="roles utilisateurs">
            <div class="col-md-6">
                <div class="cp-chart-card h-100">
                    ...
                    <div class="cp-chart-body" style="height:220px;">
                        @if($usersParRoleData->count() > 0)
                        <canvas id="usersRoleChart" data-users='{{ $usersParRoleData->values()->toJson() }}'></canvas>
                        @else
            ...
            <div class="col-md-6">
                <div class="cp-chart-card h-100">
                    ...
                    <div class="cp-chart-body" style="height:220px;">
                        @if($usersParRoleData->count() > 0)
                        <canvas id="usersRolePieChart" data-users='{{ $usersParRoleData->values()->toJson() }}'></canvas>
                        @else
                        <div class="d-flex align-items-center justify-content-center h-100 text-muted">
                            <div class="text-center">
                                <i class="bi bi-diagram-3 display-4"></i>
            ...
            <div class="col-md-6">
                <div class="cp-chart-card h-100">
                    ...
                    <div class="p-3 d-flex flex-column gap-2">
                        ...
                        <a href="{{ route('super-admin.users.create') }}" class="btn btn-outline-success text-start">
                            <i class="bi bi-person-plus me-2"></i>Ajouter un Utilisateur
                        </a>
                        <a href="{{ route('super-admin.projets.index') }}" class="btn btn-outline-primary text-start">
