...
@section('breadcrumb')
    <a href="{{ route('super-admin.taches.index') }}" class="text-decoration-none">Tâches</a>
    ...
    <div class="cp-content">
        <div class="cp-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('super-admin.taches.edit', $tache->id) }}" class="btn btn-primary px-4">
        ...
        <div class="cp-stats-grid mb-4">
            <div class="cp-stat-card">
                <div class="cp-stat-icon cp-bg-primary"><i class="bi bi-list-check"></i></div>
            ...
            <div class="cp-stat-card">
                ...
                <div class="cp-stat-content">
                    <div class="cp-stat-value">{{ $personnels->count() }}</div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <div class="cp-chart-card">
                    <div class="cp-chart-header">
                        <h6 class="cp-chart-title"><i class="bi bi-list-ul me-2"></i>Sous-tâches</h6>
                    </div>
                    <div class="p-4">
            ...
            <div class="col-lg-4">
                <div class="cp-chart-card mb-4">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span>Personnels assignés</span>
                            <span class="fw-bold">{{ $personnels->count() }}</span>
                        </div>
                ...
                <div class="cp-chart-card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="fw-semibold mb-3">{{ $tache->created_at ? $tache->created_at->format('d/m/Y à H:i') : '-' }}</div>
                        <div class="small text-muted mb-2">Dernière modification</div>
                        <div class="fw-semibold">{{ $tache->updated_at ? $tache->updated_at->format('d/m/Y à H:i') : '-' }}</div>
                    </div>
                </div>
            </div>
        </div>
