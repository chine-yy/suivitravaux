...
@section('breadcrumb')
    <span class="text-muted"><a href="{{ route('super-admin.contrats.index') }}">Contrats</a></span>
    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('super-admin.contrats.edit', $contrat->id) }}" class="btn btn-primary px-4">
                    <i class="bi bi-pencil me-2"></i>Modifier
                </a>
                <a href="{{ route('super-admin.contrats.index') }}" class="btn btn-outline-secondary px-4">
                        ...
                        <div class="mb-4 mt-4">
                            ...
                            @if($contrat->partenaire)
                                <div class="d-flex align-items-center mt-2 border rounded p-3">
                                    ...
                                    <a href="{{ route('super-admin.partenaires.show', $contrat->partenaire->id) }}" class="ms-auto text-primary" title="Voir Partenaire">
                        ...
                        <div class="mb-4">
                            ...
                            @if($contrat->projet)
                                <div class="mt-2 border rounded p-3">
                                    ...
                                    <a href="{{ route('super-admin.projets.show', $contrat->projet->id) }}" class="btn btn-sm btn-outline-primary mt-2 w-100">
                                        Voir Projet
                                    </a>
                                </div>
                            @else
