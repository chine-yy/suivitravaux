...
@section('breadcrumb')
    <a href="{{ route('super-admin.contrats.index') }}" class="text-decoration-none">Contrats</a>
...
<div class="cp-dashboard">
    <div class="cp-content">
        <div class="cp-page-header">
            <div>
                <h1 class="cp-page-title"><i class="bi bi-plus-circle me-2"></i>Nouveau Contrat</h1>
                <p class="cp-page-subtitle">Créez un nouveau contrat</p>
            </div>
            <a href="{{ route('super-admin.contrats.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="cp-chart-card">
            ...
            <div class="p-4">
                <form action="{{ route('super-admin.contrats.store') }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">N° Contrat</label>
                            <input type="text" name="numero_contrat" class="form-control @error('numero_contrat') is-invalid @enderror" value="{{ old('numero_contrat') }}" placeholder="Laisser vide pour une génération automatique (ex: 0001)">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                <option value="prestation" {{ old('type') == 'prestation' ? 'selected' : '' }}>Prestation</option>
                                <option value="marche" {{ old('type') == 'marche' ? 'selected' : '' }}>Marché</option>
                                <option value="sous_traitance" {{ old('type') == 'sous_traitance' ? 'selected' : '' }}>Sous-traitance</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="projet_id" id="projet_id" class="form-select" onchange="updateBudgetRestantContrat(this)">
                                ...
                                <option value="{{ $projet->id }}"
                                    ...
                                    {{ old('projet_id') == $projet->id ? 'selected' : '' }}>{{ $projet->nom }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="montant" id="montant" class="form-control @error('montant') is-invalid @enderror" value="{{ old('montant') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="statut" class="form-select">
                                ...
                                <option value="signe" {{ old('statut') == 'signe' ? 'selected' : '' }}>Signé</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_debut" class="form-control @error('date_debut') is-invalid @enderror" value="{{ old('date_debut') }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objet" class="form-control" rows="3">{{ old('objet') }}</textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Conditions</label>
                            <textarea name="conditions" class="form-control" rows="3">{{ old('conditions') }}</textarea>
                        </div>
                    </div>
                    <div class="d-flex gap-2 pt-4 border-top">
                        ...
                        <a href="{{ route('super-admin.contrats.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
