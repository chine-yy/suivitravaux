    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('super-admin.documents.create') }}" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="{{ route('super-admin.documents.index') }}" method="GET" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('super-admin.documents.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="cp-chart-card">
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('super-admin.documents.show', $document->id) }}"
                                        class="btn btn-sm btn-outline-info" title="Voir">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('super-admin.documents.edit', $document->id) }}"
                                        class="btn btn-sm btn-outline-primary" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('super-admin.documents.destroy', $document->id) }}"
                ...
                <button class="btn btn-outline-danger" onclick="exportToPdf('id="documentsTable"', 'Liste des documents', 'documents_export')">                    <i class="bi bi-file-earmark-pdf me-2"></i> Exporter                </button>
                                <a href="{{ route('super-admin.documents.create') }}">Créer un document</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
