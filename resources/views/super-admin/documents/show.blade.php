    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                ...
                @endif
                <a href="{{ route('super-admin.documents.edit', $document->id) }}" class="btn btn-primary px-4">
                    <i class="bi bi-pencil me-2"></i>Modifier
                </a>
                <a href="{{ route('super-admin.documents.index') }}" class="btn btn-outline-secondary px-4">
                ...
                <div class="cp-chart-card shadow-sm border-0 sticky-top" style="top: 2rem;">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-4 pt-4 border-top">
                            <div class="d-grid">
                                <form action="{{ route('super-admin.documents.destroy', $document->id) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
