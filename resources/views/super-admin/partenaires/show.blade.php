...
@section('breadcrumb')
    <a href="{{ route('super-admin.partenaires.index') }}" class="text-decoration-none">Partenaires</a>
    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('super-admin.partenaires.edit', $partenaire->id) }}" class="btn btn-green btn-with-border">
