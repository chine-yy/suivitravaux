    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="card-body p-4">
                <form action="{{ route('super-admin.partenaires.update', $partenaire) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-bold">Projet à suivre <span class="text-danger">*</span></label>
                    ...
                    <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                        <a href="{{ route('super-admin.partenaires.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
