...
@section('breadcrumb')
    <span class="text-muted"><a href="{{ route('super-admin.factures.index') }}">Factures</a></span>
    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('super-admin.factures.edit', $facture->id) }}" class="btn btn-primary px-4">
                    <i class="bi bi-pencil me-2"></i>Modifier
                </a>
                <a href="{{ route('super-admin.factures.index') }}" class="btn btn-outline-secondary px-4">
                        ...
                        <div class="mb-4">
                            ...
                            @if($facture->projet)
                                <div class="px-3 py-3 border rounded">
                                    ...
                                    <a href="{{ route('super-admin.projets.show', $facture->projet->id) }}" class="btn btn-sm btn-outline-primary mt-3 w-100">
                                        Voir Projet
                                    </a>
                                </div>
                            @else
