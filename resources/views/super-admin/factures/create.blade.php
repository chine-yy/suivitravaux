    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="p-4">
                ...
                <form action="{{ route('super-admin.factures.store') }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">N° Facture</label>
                            <input type="text" name="numero_facture" class="form-control @error('numero_facture') is-invalid @enderror" value="{{ old('numero_facture') }}" placeholder="Laisser vide pour une génération automatique (ex: 0001)">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select" required>
                                ...
                                <option value="proforma" {{ old('type') == 'proforma' ? 'selected' : '' }}>Proforma</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" name="montant_tva" class="form-control" value="{{ old('montant_tva') }}">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" name="montant_ttc" id="montant_ttc"
                                ...
                                value="{{ old('montant_ttc') }}" min="0" inputmode="decimal">
                            @error('montant_ttc') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Date Émission</label>
                            <input type="date" name="date_emission" class="form-control" value="{{ old('date_emission') }}">
                        </div>
                        <div class="col-md-4">
