        ...
        <div class="cp-content">
            <div class="cp-page-header">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('super-admin.projets.create') }}" class="btn btn-primary px-4">
            ...
            <div class="cp-chart-card mb-4">
                ...
                <div class="p-4">
                    <form action="{{ route('super-admin.projets.index') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('super-admin.projets.index') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex gap-1 justify-content-end">
                                            ...
                                            <a href="{{ route('super-admin.projets.edit', $projet->id) }}"
                                                class="btn btn-sm btn-outline-primary" title="Modifier">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            @include('partials.row-export', ['id' => $projet->id, 'prefix' => 'projet', 'title' => 'Projet', 'project_name_only' => true])
                                            <form action="{{ route('super-admin.projets.destroy', $projet->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        <a href="{{ route('super-admin.projets.create') }}">Créer un projet</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
