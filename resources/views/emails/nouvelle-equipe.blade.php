...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <strong>{{ $chef->name }}</strong>,</p>
            
            <p>Nous vous informons que vous avez été désigné(e) comme <strong>Chef de l'équipe</strong> "<strong>{{ $equipe->nom }}</strong>".</p>
            
            <p>En tant que chef d'équipe, vous serez responsable de l'organisation et du bon déroulement des missions confiées à votre groupe sur le projet <strong>{{ $equipe->projet->nom ?? 'N/A' }}</strong>.</p>
