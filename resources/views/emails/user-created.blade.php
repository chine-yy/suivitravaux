...
<head>
    ...
    <title>Bienvenue sur {{ config('app.name') }} - Création de compte</title>
    <style>
    ...
    <div class="container">
        <div class="email-wrapper">
            ...
            <div class="email-body">
                ...
                <p>Un compte Membre a été créé pour vous sur la plateforme {{ config('app.name') }}.</p>
                ...
                <div class="welcome-box">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value" style="background-color: #fee2e2; padding: 2px 6px; border-radius: 4px; font-family: monospace;">{{ $password }}</span>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <a href="{{ url('/login') }}" class="btn-connect">Accéder au site</a>
                </div>
