    ...
    <div class="content">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td><span class="badge bg-green">{{ $rapport->getTypeLabel() }}</span></td>
            </tr>
            <tr>
                <td class="label">Auteur</td>
                <td>
                    <strong>{{ $rapport->auteur->prenom ?? '' }} {{ $rapport->auteur->name ?? 'N/A' }}</strong><br>
                    <span class="badge bg-blue" style="font-size:10px;">{{ $rapport->auteur->role->nom ?? 'Auteur' }}</span>
                </td>
            </tr>
            <tr>
        ...
        @if($rapport->avancement_constate)
            ...
            <div style="margin-top: 10px;">
                <div class="progress-bg">
                    <div class="progress-bar" style="width: {{ $rapport->avancement_constate }}%;">
