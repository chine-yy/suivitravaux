    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('role-dynamique.roles.create') }}" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.roles.index') }}" method="GET" class="row g-3">
                    <div class="col-md-9">
                        ...
                        <table class="table table-hover mb-0" id="rolesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <a href="{{ route('role-dynamique.roles.show', $role->id) }}" class="btn btn-sm btn-outline-primary" title="Voir détails">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            @endif
                                            @if(auth()->user()->hasPermission('edit-roles-permissions'))
                                            <a href="{{ route('role-dynamique.roles.edit', $role) }}" class="btn btn-sm btn-outline-secondary" title="Modifier les permissions">
                                            ...
                                            <form action="{{ route('role-dynamique.roles.destroy', $role) }}" method="POST" onsubmit="return confirm('Supprimer ce rôle ?');" class="d-inline">
                                                @csrf @method('DELETE')
                                ...
                                <i class="bi bi-shield-x" style="font-size:2rem;"></i>
                                        <p class="mt-2">Aucun rôle créé. <a href="{{ route('role-dynamique.roles.create') }}">Créer le premier rôle</a></p>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
