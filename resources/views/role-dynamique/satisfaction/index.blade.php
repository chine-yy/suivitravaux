...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.satisfaction.index') }}" method="GET" class="row g-3">
                    <div class="col-md-5">
                        ...
                        <select name="partenaire_id" class="form-select form-select-sm">
                            ...
                            <option value="{{ $c->id }}" {{ request('partenaire_id')==$c->id ? 'selected' : '' }}>
                                {{ trim(($c->prenom ?? '') . ' ' . ($c->name ?? '')) ?: ('Partenaire #' . $c->id) }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('role-dynamique.satisfaction.index') }}"
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="satisfactionTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $satisfaction->partenaire ? trim(($satisfaction->partenaire->prenom ?? '') . ' ' . ($satisfaction->partenaire->name ?? '')) : 'N/A' }}</td>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    ...
                                    <a href="{{ route('role-dynamique.satisfaction.show', $satisfaction->id) }}"
