...
@section('breadcrumb')
    <a href="{{ route('role-dynamique.satisfaction.index') }}" class="text-decoration-none">Satisfaction</a>
    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('role-dynamique.satisfaction.index') }}" class="btn btn-outline-secondary px-4">
