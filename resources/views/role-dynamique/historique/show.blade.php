...
@section('breadcrumb')
<a href="{{ route('role-dynamique.historique.index') }}" class="cp-breadcrumb-item">Historique</a>
...
<div class="d-flex gap-2">
                <a href="{{ route('role-dynamique.historique.pdf', $annee) }}" class="btn btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf me-2"></i>Exporter tout
                </a>
                <a href="{{ route('role-dynamique.historique.voir-pdf', $annee) }}" class="btn btn-outline-primary" target="_blank">
                    <i class="bi bi-eye me-2"></i>Voir PDF
                </a>
                <a href="{{ route('role-dynamique.historique.index') }}" class="btn btn-outline-secondary">
