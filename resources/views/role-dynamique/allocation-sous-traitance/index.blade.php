...
@section('title', 'Allocation Budget Sous-Traitance')
    ...
    <div class="cp-content">
        ...
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                @if($has('exporter-pdf-budget-allocation-sous-traitance'))
        ...
        <div class="cp-card mb-4">
            ...
            <div class="p-3 bg-light border-bottom">
                <form action="{{ route('role-dynamique.allocation-sous-traitance.index') }}" method="GET" class="row g-2">
                    <div class="col-md-10">
                    ...
                    <div class="col-md-2 d-flex gap-1">
                        ...
                        <a href="{{ route('role-dynamique.allocation-sous-traitance.index') }}" class="btn btn-sm btn-outline-secondary"><i
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        @if($has('edit-budget-allocation-sous-traitance'))
                                        ...
                                        @endif
                                        @if($has('exporter-pdf-budget-allocation-sous-traitance'))
                                        <a href="{{ route('role-dynamique.export.pdf.direct', ['type' => 'soustraitance', 'id' => $st->id]) }}"
                                            class="btn btn-sm btn-outline-secondary" title="Télécharger">
                                            <i class="bi bi-download"></i>
                                        </a>
                                        @endif
                                        @if($has('delete-budget-allocation-sous-traitance'))
                                        <form action="{{ route('role-dynamique.allocation-sous-traitance.destroy', $st->id) }}"
                                            method="POST" class="d-inline" onsubmit="return confirm('Réinitialiser le budget de cette sous-traitance ?')">
                                            @csrf @method('DELETE')
...
<div class="modal fade" id="modalUpdateST" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('role-dynamique.allocation-sous-traitance.store') }}" method="POST">
                @csrf
