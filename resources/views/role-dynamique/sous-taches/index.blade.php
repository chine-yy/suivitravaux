        ...
        <div class="cp-content">
            <div class="cp-page-header">
                ...
                <div class="d-flex gap-2">
                    @if($canPermission('exporter-pdf-sous-taches'))
                        <button class="btn btn-outline-danger"
                            onclick="exportToPdf('sous-tachesTable', 'Liste des Sous-Tâches', 'sous-taches_export')">
                            <i class="bi bi-file-earmark-pdf me-2"></i>Exporter PDF
                        </button>
                    @endif
                    @if($canPermission('create-sous-taches'))
                        <a href="{{ route('role-dynamique.sous-taches.create') }}" class="btn btn-primary px-4">
                            <i class="bi bi-plus-circle me-2"></i>Nouvelle Sous-Tâche
                        </a>
                    @endif
                </div>
            </div>
            ...
            <div class="cp-chart-card mb-4">
                ...
                <div class="p-4">
                    <form action="{{ route('role-dynamique.sous-taches.index') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('role-dynamique.sous-taches.index') }}"
 ...
 $sousTache->tache->projet ? $sousTache->tache->projet->nom : 'N/A' }}
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex gap-1 justify-content-end">
                                                            @if($canPermission('view-sous-taches'))
                                                                <a href="{{ route('role-dynamique.sous-taches.show', $sousTache->id) }}"
                                                            ...
                                                            @endif
                                                            @if($canPermission('edit-sous-taches'))
                                                                <a href="{{ route('role-dynamique.sous-taches.edit', $sousTache->id) }}"
                                                                    class="btn btn-sm btn-outline-primary" title="Modifier">
                                                                    <i class="bi bi-pencil"></i>
                                                                </a>
                                                            @endif
                                                            @if($canPermission('delete-sous-taches'))
                                                                <form action="{{ route('role-dynamique.sous-taches.destroy', $sousTache->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-muted">
                                        ...
                                        @endif
                                        @if($canPermission('create-sous-taches'))
                                            <a href="{{ route('role-dynamique.sous-taches.create') }}">Créer une sous-tâche</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforelse
