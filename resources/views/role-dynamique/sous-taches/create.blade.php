...
@section('title', 'Nouvelle Sous-Tâche')
...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.sous-taches.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="titre" class="form-control @error('titre') is-invalid @enderror"
                                value="{{ old('titre') }}" required placeholder="Titre de la sous-tâche">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tache_id" id="tache_id" class="form-select @error('tache_id') is-invalid @enderror" required>
                                ...
                                @foreach($taches as $t)
                                    <option value="{{ $t->id }}" data-projet-id="{{ $t->projet_id }}" data-phase-id="{{ $t->phase_id }}" {{ old('tache_id') == $t->id ? 'selected' : '' }}>
                                        {{ $t->titre ?? 'Tâche #' . $t->id }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="date_fin_prevue" class="form-control @error('date_fin_prevue') is-invalid @enderror" value="{{ old('date_fin_prevue') }}">
                    ...
                    <div class="d-flex gap-2 pt-3 border-top mt-4">
                        ...
                        <a href="{{ route('role-dynamique.sous-taches.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
