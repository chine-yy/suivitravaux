    ...
    <div class="cp-content">
        ...
        <div class="cp-chart-card">
            ...
            <div class="card-body p-4">
                <form action="{{ route('role-dynamique.projets.update', $projet->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_debut" class="form-control @error('date_debut') is-invalid @enderror" value="{{ old('date_debut', $projet->date_debut ? $projet->date_debut->format('Y-m-d') : '') }}">
                            @error('date_debut') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Date de Fin Prévue</label>
                            <input type="date" name="date_fin" class="form-control @error('date_fin') is-invalid @enderror" value="{{ old('date_fin', $projet->date_fin_prevue ? $projet->date_fin_prevue->format('Y-m-d') : '') }}">
                            @error('date_fin') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Date de Fin Réelle</label>
                            <input type="date" name="date_fin_reelle" class="form-control @error('date_fin_reelle') is-invalid @enderror" value="{{ old('date_fin_reelle', $projet->date_fin_reelle ? $projet->date_fin_reelle->format('Y-m-d') : '') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="statut" class="form-select @error('statut') is-invalid @enderror">
                                ...
                                <option value="en_retard" {{ old('statut', $projet->statut) == 'en_retard' ? 'selected' : '' }}>En retard</option>
                            </select>
                    ...
                    <div class="mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                        <a href="{{ route('role-dynamique.projets.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
