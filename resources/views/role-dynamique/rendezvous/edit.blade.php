...
<div class="cp-dashboard">
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <a href="{{ route('role-dynamique.rendezvous.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="cp-chart-card">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.rendezvous.update', $rendezvous->id) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2 pt-4 border-top">
                        ...
                        <a href="{{ route('role-dynamique.rendezvous.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
