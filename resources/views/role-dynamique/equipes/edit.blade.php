...
@section('breadcrumb')
    <a href="{{ route('role-dynamique.equipes.index') }}" class="text-decoration-none">Équipes</a>
...
<div class="cp-dashboard">
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <a href="{{ route('role-dynamique.equipes.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="cp-chart-card">
                    ...
                    <div class="p-4">
                        <form action="{{ route('role-dynamique.equipes.update', $equipe->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex gap-2 pt-2 border-top">
                                ...
                                <a href="{{ route('role-dynamique.equipes.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
                            </div>
                        </form>
                    </div>
                </div>
