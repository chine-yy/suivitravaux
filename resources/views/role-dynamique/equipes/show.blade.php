...
@section('breadcrumb')
    <span class="text-muted"><a href="{{ route('role-dynamique.equipes.index') }}">Équipes</a></span>
...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="cp-page-header d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('role-dynamique.equipes.index') }}" class="btn btn-outline-secondary px-4">
                ...
                <div class="cp-chart-card mb-4 h-100">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-grid gap-2 mt-4 pt-3 border-top">
                            <a href="{{ route('role-dynamique.equipes.edit', $equipe->id) }}" class="btn btn-primary">
