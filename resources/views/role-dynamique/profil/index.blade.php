            ...
            <div class="row g-4">
                <div class="col-lg-7 col-xl-8 order-2 order-lg-1">
                    <div class="cp-chart-card">
                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('role-dynamique.parametres.update') }}"
                                ...
                                <div class="d-flex gap-2 pt-4 border-top">
                                    ...
                                    <a href="{{ route('role-dynamique.dashboard') }}"
                ...
                <div class="col-lg-5 col-xl-4 order-1 order-lg-2">
                    <div class="cp-chart-card mb-4">
                        ...
                        <div class="p-4 text-center">
                            ...
                            <p class="text-muted small mb-2">{{ $user->role->nom ?? 'Collaborateur' }}</p>
                            ...
                            <div class="mt-2">
                                <form method="POST" action="{{ route('role-dynamique.parametres.photo.destroy') }}">
                                    @csrf
                                    @method('DELETE')
