...
@section('breadcrumb')
    <a href="{{ route('role-dynamique.interventions.index') }}" class="text-muted text-decoration-none">Interventions</a>
    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                ...
                @include('partials.row-export', ['id' => $intervention->id, 'prefix' => 'intervention', 'title' => 'Détail - Intervention'])
                @endif
                @if($has('edit-interventions'))
                <a href="{{ route('role-dynamique.interventions.edit', $intervention->id) }}" class="btn btn-outline-primary px-4">
                    <i class="bi bi-pencil me-2"></i>Modifier
                </a>
                @endif
                <a href="{{ route('role-dynamique.interventions.index') }}" class="btn btn-outline-secondary px-4">
