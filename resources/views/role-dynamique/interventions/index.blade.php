    ...
    <div class="cp-content">
        <div class="cp-page-header">
            ...
            <div class="d-flex gap-2">
                @if($has('exporter-pdf-interventions'))
                ...
                @endif
                @if($has('create-interventions'))
                <a href="{{ route('role-dynamique.interventions.create') }}" class="btn btn-primary px-4">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.interventions.index') }}" method="GET" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('role-dynamique.interventions.index') }}"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('role-dynamique.interventions.show', $intervention->id) }}"
                                    ...
                                    @endif
                                    @if($has('edit-interventions'))
                                    <a href="{{ route('role-dynamique.interventions.edit', $intervention->id) }}"
                                        class="btn btn-sm btn-outline-primary" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    @endif
                                    @if($has('delete-interventions'))
                                    <form action="{{ route('role-dynamique.interventions.destroy', $intervention->id) }}"
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5 text-muted">
                                ...
                                @if($has('create-interventions'))
                                <a href="{{ route('role-dynamique.interventions.create') }}">Créer une intervention</a>
                                @endif
                            </td>
                        </tr>
                        @endforelse
