        ...
        <div class="cp-content">
            ...
            <div class="cp-chart-card">
                ...
                <div class="p-4">
                    ...
                    <form action="{{ route('role-dynamique.factures.update', $facture->id) }}" method="POST">
                        @csrf @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type" class="form-select">
                                    <option value="facture" {{ $facture->type == 'facture' ? 'selected' : '' }}>Facture
                                    </option>
                                    <option value="avoir" {{ $facture->type == 'avoir' ? 'selected' : '' }}>Avoir</option>
                                    <option value="proforma" {{ $facture->type == 'proforma' ? 'selected' : '' }}>Proforma
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date_emission" class="form-control"
                                    value="{{ $facture->date_emission ? date('Y-m-d', strtotime($facture->date_emission)) : '' }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Date Échéance</label>
                                <input type="date" name="date_echeance" class="form-control"
                                    value="{{ $facture->date_echeance ? date('Y-m-d', strtotime($facture->date_echeance)) : '' }}">
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="statut_paiement" class="form-select">
                                    ...
                                    <option value="paye" {{ $facture->statut_paiement == 'paye' ? 'selected' : '' }}>Payé
                                    </option>
                                    <option value="en_retard" {{ $facture->statut_paiement == 'en_retard' ? 'selected' : '' }}>En retard</option>
                                    <option value="annule" {{ $facture->statut_paiement == 'annule' ? 'selected' : '' }}>
                                        Annulé</option>
                                </select>
                            </div>
                            <div class="col-12">
