...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <div class="modal fade" id="partenaireCountModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg rounded-4">
                    ...
                    <form action="{{ route('role-dynamique.partenaires.create') }}" method="GET">
        ...
        <div class="cp-chart-card mb-4">
            ...
            <div class="p-4">
                <form action="{{ route('role-dynamique.partenaires.index') }}" method="GET" class="row g-3">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-3 d-flex align-items-end gap-2">
                        ...
                        <a href="{{ route('role-dynamique.partenaires.index') }}" class="btn btn-sm btn-outline-secondary">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('role-dynamique.partenaires.show', $partenaire->id) }}" class="btn btn-sm btn-outline-info" title="Voir">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    @if($has('edit-partenaires'))
                                    <a href="{{ route('role-dynamique.partenaires.edit', $partenaire->id) }}" class="btn btn-sm btn-outline-primary" title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    @endif
                                    @if($has('reset-password-partenaires'))
                                    <form action="{{ route('role-dynamique.partenaires.reset-password', $partenaire->id) }}"
                                        method="POST"
                                    ...
                                    @endif
                                    @if($has('delete-partenaires'))
                                    <form action="{{ route('role-dynamique.partenaires.destroy', $partenaire->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
