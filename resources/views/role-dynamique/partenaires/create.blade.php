...
@section('breadcrumb')
    <a href="{{ route('role-dynamique.partenaires.index') }}" class="text-decoration-none text-muted">Partenaires</a>
...
<div class="cp-dashboard">
    <div class="cp-content">
        ...
        <form action="{{ route('role-dynamique.partenaires.store') }}" method="POST">
            @csrf
                ...
                <div class="col-12">
                    <div class="cp-chart-card border-0 shadow-sm">
                        ...
                        <div class="p-4">
                            ...
                            @for($i = 0; $i < $count; $i++)
                            <div class="partenaire-form-block {{ $i > 0 ? 'mt-4 pt-4 border-top' : '' }}">
                                <h6 class="fw-bold text-green mb-3"><i class="bi bi-person-circle me-2"></i>Partenaire #{{ $i + 1 }}</h6>
                                <div class="row g-3">
            ...
            <div class="mt-4 pt-3 d-flex justify-content-end gap-2">
                <a href="{{ route('role-dynamique.partenaires.index') }}" class="btn btn-outline-secondary px-5 py-2">
                    Annuler
                </a>
