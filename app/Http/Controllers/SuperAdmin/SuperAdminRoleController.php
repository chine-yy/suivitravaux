...
class SuperAdminRoleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allRoles = Role::whereNotIn('nom', ['Administration', User::ROLE_SUPER_ADMIN, 'Partenaire'])->get();
        ...
        return view('super-admin.roles.index', compact(
            'roles',
            'totalRoles',
    ...
    public function edit(Role $role)
    {
        ...
        return view('super-admin.roles.edit', compact('role', 'permissions', 'selectedPermissions'));
    }
    ...
    /**
     * Dupliquer un rôle existant (avec ses permissions).
     */
    ...
    /**
     * Attribution rapide : assigner un rôle à un utilisateur depuis le dashboard.
     */
    public function quickRole(Request $request)
    {
        ...
        return redirect()->route('super-admin.dashboard')->with('success', $message);
    }
}
